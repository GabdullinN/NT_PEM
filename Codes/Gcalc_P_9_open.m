...
%
Aall(20) = pi*r2^2;
Aall(21) = pi*r2^2 - pi*r1b^2; %using min botl r1
Aall(22) = Aall(21);
Aall(23) = Aall(21);
Aall(24) = Aall(21);
%
...
% 
Aall(1) = Aall(20); %%actually the idea of counting the bolt makes sence for small gap. but big gap flux will just spread out into intermediate areas
%
Aall(2) = a4 * l5;
...
lall(52) = 9.5; %the leakage logic doubles the length, but this makes reluctance inconsistant in this case. so just coil leakage length of 9.5 mm
